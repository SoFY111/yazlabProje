...
const AppealDetail = () => {
  ...
  const ignoreAppeal = async (appealUUID, userId, description) => {
    console.log('appealUUID:' + appealUUID)
    ...
    <>
      ...
      <View style={{ padding: 8 }}>
          ...
          <View style={{ flexDirection: "column", alignContent: "center" }}>
            <View style={styles.links}>
              ...
              <Pressable onPress={async () => await getDownloadURLFromFirestoreURL(appealDetail?.files?.fileX)}>
                <Icon style={{ padding: 3, borderWidth: 1, borderRadius: 4, borderColor: appealDetail?.files?.fileX !== undefined  ? appealDetail?.files?.fileX !== null ? "#5AA658" : 'gray' : 'gray' }} name="eye"
                      type="ionicon" color={appealDetail?.files?.fileX !== undefined  ? appealDetail?.files?.fileX !== null ? "#5AA658" : 'gray' : 'gray'} size={15} />
              </Pressable>
            </View>
            ...
            <View style={styles.links}>
              ...
              <Pressable onPress={async () => await getDownloadURLFromFirestoreURL(appealDetail?.files?.fileY)}>
                <Icon style={{ padding: 3, borderWidth: 1, borderRadius: 4, borderColor: appealDetail?.files?.fileY !== undefined  ? appealDetail?.files?.fileY !== null ? "#5AA658" : 'gray' : 'gray' }} name="eye"
                      type="ionicon" color={appealDetail?.files?.fileY !== undefined  ? appealDetail?.files?.fileY !== null ? "#5AA658" : 'gray' : 'gray'} size={15} />
              </Pressable>
            </View>
            ...
            <View style={styles.links}>
              ...
              <Pressable onPress={async () => await getDownloadURLFromFirestoreURL(appealDetail?.files?.fileZ)}>
                <Icon style={{ padding: 3, borderWidth: 1, borderRadius: 4, borderColor: appealDetail?.files?.fileZ !== undefined  ? appealDetail?.files?.fileZ !== null ? "#5AA658" : 'gray' : 'gray' }} name="eye"
                      type="ionicon" color={appealDetail?.files?.fileZ !== undefined  ? appealDetail?.files?.fileZ !== null ? "#5AA658" : 'gray' : 'gray'} size={15} />
              </Pressable>
            </View>
            ...
            <View style={styles.links}>
              ...
              <Pressable onPress={async () => await getDownloadURLFromFirestoreURL(appealDetail?.files?.fileQ)}>
                <Icon style={{ padding: 3, borderWidth: 1, borderRadius: 4, borderColor: appealDetail?.files?.fileQ !== undefined  ? appealDetail?.files?.fileQ !== null ? "#5AA658" : 'gray' : 'gray' }} name="eye"
                      type="ionicon" color={appealDetail?.files?.fileQ !== undefined  ? appealDetail?.files?.fileQ !== null ? "#5AA658" : 'gray' : 'gray'} size={15} />
              </Pressable>
            </View>
            ...
            <View style={styles.links}>
              ...
              <Pressable onPress={async () => await getDownloadURLFromFirestoreURL(appealDetail?.files?.fileF)}>
                <Icon style={{ padding: 3, borderWidth: 1, borderRadius: 4, borderColor: appealDetail?.files?.fileF !== undefined  ? appealDetail?.files?.fileF !== null ? "#5AA658" : 'gray' : 'gray' }} name="eye"
                      type="ionicon" color={appealDetail?.files?.fileF !== undefined  ? appealDetail?.files?.fileF !== null ? "#5AA658" : 'gray' : 'gray'} size={15} />
              </Pressable>
            </View>
          </View> :
        ...
        <View style={{padding: 24}}>
          <TextInput label='Açıklama' value={description} onChangeText={(text) => setDescription(text)}/>
        </View>

      </View>
      <View style={{flexDirection:"row", justifyContent:"space-around", marginVertical:12, position:'absolute', width:'100%', bottom:0, left:0, }}>
        <Button mode='contained' disabled={description === ""} style={{backgroundColor: description === "" ? '#D5D5D5' : '#cf3830'}} onPress={() => ignoreAppeal(appealUUID, userId, description)}><Text style={{color:'#fff'}} >REDDET</Text></Button>
        <Button mode='contained' disabled={description === ""} onPress={() => approveAppeal(appealUUID)}><Text style={{color:'#fff'}} >KABUL ET</Text></Button>
      </View>
    </>
  );
};
